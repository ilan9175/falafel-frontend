...
import { Button, IconButton, useModal, AddIcon, Image } from 'flf-uikit'
    ...
    <Card isActive={isCardActive} isFinished={isFinished && sousId !== 0}>
      ...
      <div style={{ padding: '24px' }}>
        ...
        <div style={{ marginBottom: '8px', display: 'flex', alignItems: 'center' }}>
          <div style={{ flex: 1 }}>
            <Image
              src={`https://raw.githubusercontent.com/ilan9175/flf-frontend/master/public/images/pools/${poolImage}`}
...
const PoolFinishedSash = styled.div`
  background-image: url('https://raw.githubusercontent.com/ilan9175/flf-frontend/master/public/images/pool-finished-sash.svg');
