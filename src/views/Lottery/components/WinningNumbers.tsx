...
import { Image, Card, CardBody } from 'flf-uikit'
          ...
          <StyledCardContentInner>
            ...
            <RabbitRow>
              <RabbitBox>
                <CardImageFirst>
                  <Image
                    src="https://raw.githubusercontent.com/ilan9175/flf-frontend/master/public/images/sign bunny 1@2x.png"
                    alt="Number 1"
                    width={200}
                    height={150}
                    responsive
              ...
              <RabbitBox>
                <CardImage style={{ marginLeft: '-1.2em' }}>
                  <Image
                    src="https://raw.githubusercontent.com/ilan9175/flf-frontend/master/public/images/sign bunny 2@2x.png"
                    alt="Number 2"
                    width={200}
                    height={150}
                    responsive
              ...
              <RabbitBox>
                <CardImage style={{ marginLeft: '-1.2em' }}>
                  <Image
                    src="https://raw.githubusercontent.com/ilan9175/flf-frontend/master/public/images/sign bunny 3@2x.png"
                    alt="Number 3"
                    width={200}
                    height={150}
                    responsive
              ...
              <RabbitBox>
                <CardImage style={{ marginLeft: '-1.2em' }}>
                  <Image
                    src="https://raw.githubusercontent.com/ilan9175/flf-frontend/master/public/images/sign bunny 4@2x.png"
                    alt="Number 4"
                    width={200}
                    height={150}
                    responsive
