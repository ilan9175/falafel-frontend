...
import { Flex, Text, Skeleton } from 'flf-uikit'
...
const FarmCard: React.FC<FarmCardProps> = ({ farm, removed, cakePrice, bnbPrice, ethereum, account }) => {
  ...
  return (
    <FCard>
      {farm.tokenSymbol === 'MOONICA' && <StyledCardAccent />}
      <CardHeading
        lpLabel={lpLabel}
...
const FarmFinishedSash = styled.div`
  background-image: url('https://raw.githubusercontent.com/ilan9175/falafel-frontend/master/public/images/pool-finished-sash.svg');
